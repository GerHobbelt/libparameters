...
// showcases the scenario where all parameters are member variables of an application class. 
//
// Note: the application class is a singleton. 
...
#define main param_scoped_to_container_example_main
#endif
